...
export default {
  ...
  computed: {
    ...mapState({
      "historyKeywords": state => state.goods.historyKeywords,
      "hotKeywords": state => state.goods.hotKeywords,
    })
  },
  methods: {
    ...mapMutations({
      SET_KWORDS: "goods/SET_HISTORYKEYWORDS",
      CLEAR_KEYWORDS: "goods/CLEAR_HISTORYWORDS",
    }),
    ...mapActions({
      getHotKeywords: "goods/getHotKeywords",
    }),

    goSearch(keyword) {
      let tempKeyword = this.keyword || keyword || "";
      if (tempKeyword) {
        ...
        this.SET_KWORDS({historyKeywords: this.keywords})
      }
      this.show.show = false;
      if (this.isLocal) {
        this.$router.replace('/classify/goods?kwords=' + tempKeyword);
        console.log("isLocal");
      } else {
        this.$router.push("/classify/goods?kwords=" + tempKeyword);
