<template>
  <div>
    ...
    <div class='order-status-wrap'>
      ...
      <div class='item' @click="$router.push('/user/order/reviewOrders?status=2')">
    ...
    <div class="menu-list-wrap">
      ...
      <ul @click="goPage('/user/modCellphone')">
        <li>绑定手机</li>
        <li></li>
      </ul>
      <ul @click="goPage('/user/modPassword')">
        <li>修改密码</li>
        <li></li>
      </ul>
      <ul @click="goPage('/user/favs')">
        <li>我的收藏</li>
        <li></li>
      </ul>
