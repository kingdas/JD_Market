    ...
    <div class='main'>
      ...
      <div class='address-wrap'>
        ...
        <div class='address-info'>
          ...
          <div class='cellphone'><img src="../../../assets/images/common/cellphone.png"
                                      alt=""/>{{ orderInfo.cellphone }}
          </div>
          <div class='address'>{{ orderInfo.province }}{{ orderInfo.city }}{{ orderInfo.area }}{{ orderInfo.address }}
          </div>
        </div>
        <div class='skew-wrap'>
          <div class='skew'></div>
      ...
      <div class='goods-list' v-for="(item,index) in orderInfo.goods" :key="index"
