<template>
  <div class="page">
    <div :class="{header:true,scroll:isScrollTop}">
      <div class="classify-icon" @click="$router.push('/classify/classify')"></div>
      <div class="search-wrap">
        <div class="search-icon"></div>
        <div class="text" @click="searchShow.show = true">请输入宝贝名称</div>
      </div>
    ...
    <div class="quick-nav">
      <ul class="item" v-for="(item,index) in navs" :key="index"
          @click="$router.push('/classify/classify/items?cid='+item.cid)">
    ...
    <template v-for="(item,index) in goods">
      <div class="goods-main" :key="index" v-if="(index%2)===0">
